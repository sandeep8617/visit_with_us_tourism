...
api.upload_folder(
    ...
    repo_id="sandeep8617/visit-with-us-tourism-project-model",          # Target repository on Hugging Face where the files will be uploaded
    repo_type="model",                          # Can be "dataset", "model", or "space" depending on the type of repository
